...
final class Settings: NSWindow {
    ...
    init(_ style: Style, map: Map) {
        super.init(contentRect: .init(x: NSScreen.main!.frame.midX - 200, y: NSScreen.main!.frame.midY - 150, width: 400, height: 300), styleMask: [.borderless], backing: .buffered, defer: false)
